  ...
  return (
    <div className="w-full px-6 max-w-7xl mx-auto mt-4 mb-10">
      <div className="border-b-news-thick pb-6 mb-6 text-center">
        ...
        <h2 className="text-[10px]  tracking-[0.3em] font-inter text-dark-charcoal font-bold mb-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pb-8 border-b-news-double">
        <div className="md:col-span-1 md:pr-6 md:border-r border-black/20">
          <h3 className="text-lg font-playfair font-black mb-3  tracking-wider">The Market Evolves</h3>
        ...
        <div className="md:col-span-1 md:pr-6 md:border-r border-black/20">
           <h3 className="text-lg font-playfair font-black mb-3  tracking-wider">Three Core Models</h3>
           ...
           <p className="text-[10px]  font-inter tracking-widest font-bold text-center">
             Powered by AI Insights
           </p>
        </div>
        <div className="md:col-span-1">
          <h3 className="text-lg font-playfair font-black mb-3  tracking-wider">Action Unwillingly</h3>
          <p className="text-xs font-ibm leading-relaxed text-justify">
