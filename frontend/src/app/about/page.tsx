    ...
    <div className="min-h-screen bg-ivory">
      ...
      <div className="pt-4 pb-24 px-6 max-w-7xl mx-auto">
        ...
        <div className="border-b-news-thick pb-6 mb-10 text-center">
          <p className="text-[10px] font-bold  tracking-[0.25em] font-inter text-dark-charcoal mb-4">Our Mission</p>
        ...
        <div className="max-w-4xl mx-auto editorial-panel p-10 md:p-16 border-y-news-double mb-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="md:border-r border-black md:pr-8">
              <h3 className="text-3xl font-black font-playfair text-foreground  mb-6 tracking-tight">The Ecosystem</h3>
            ...
            <div className="flex flex-col justify-center">
              <div className="border border-gold p-8 bg-[#1A1C20] shadow-[4px_4px_0px_rgba(212,175,55,1)]">
                <h4 className="text-gold font-black font-playfair text-2xl  mb-4">Evolving System</h4>
                ...
                <div className="flex justify-between items-center text-[9px] text-gold font-bold tracking-widest  font-inter">
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 items-start">
          <div className="md:col-span-1">
            <h3 className="text-lg font-playfair font-black mb-4  tracking-wider border-b border-black pb-2">The Builder</h3>
        ...
        <div className="max-w-4xl mx-auto mt-20 pt-8 border-t-news-double flex justify-center">
          <span className="text-[10px] font-inter font-bold  tracking-[0.5em] text-dark-charcoal/40">
